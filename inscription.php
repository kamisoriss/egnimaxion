<!--
	...
	Rôle : formulaire d'inscription utilisateur et traitement POST minimal.
	Notes : La logique de stockage n'est pas implémentée ici — il faut ajouter
	validation, hachage de mot de passe et insertion en base pour production.
-->
<!DOCTYPE html>
<html lang="fr">
<head>
